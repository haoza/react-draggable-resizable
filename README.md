...
For examples of the component go to the [live playground](https://mauricius.github.io/react-draggable-resizable/)
...
```html
<ReactDraggableResizable class-name="my-class">
```
...
```html
<ReactDraggableResizable class-name-draggable="my-draggable-class">
```
...
```html
<ReactDraggableResizable class-name-resizable="my-resizable-class">
```
...
```html
<ReactDraggableResizable class-name-dragging="my-dragging-class">
```
...
```html
<ReactDraggableResizable class-name-resizing="my-resizing-class">
```
...
```html
<ReactDraggableResizable class-name-active="my-active-class">
```
...
```html
<ReactDraggableResizable class-name-handle="my-handle-class"></react-draggable-resizable>
```
...
```html
<ReactDraggableResizable :scale="0.5">

<ReactDraggableResizable :scale="[0.5, 0.4]">
```
...
```html
<ReactDraggableResizable :disable-user-select="false">
```
...
```html
<ReactDraggableResizable :enable-native-drag="true">
```
...
```html
<ReactDraggableResizable :active="true">
```
...
```html
<ReactDraggableResizable :prevent-deactivation="true">
```
...
```html
<ReactDraggableResizable :draggable="false">
```
...
```html
<ReactDraggableResizable :resizable="false">
```
...
```html
<ReactDraggableResizable :min-width="50">
```
...
```html
<ReactDraggableResizable :min-height="50">
```
...
```html
<ReactDraggableResizable :max-width="400">
```
...
```html
<ReactDraggableResizable :max-height="50">
```
...
```html
<ReactDraggableResizable :handles="['tm','bm','ml','mr']">
```
...
```html
<ReactDraggableResizable axis="x">
```
...
```html
<ReactDraggableResizable :grid="[1,1]">
```
...
```html
<ReactDraggableResizable :parent="true">
```
...
```html
<ReactDraggableResizable drag-handle=".drag">
```
...
```html
<ReactDraggableResizable drag-cancel=".drag">
```
...
```html
<ReactDraggableResizable :lock-aspect-ratio="true">
```
...
```html
<ReactDraggableResizable :onDragStart="onDragStartCallback">
```
...
```html
<ReactDraggableResizable :onDrag="onDragCallback">
```
...
```html
<ReactDraggableResizable :onResizeStart="onResizeStartCallback">
```
...
```html
<ReactDraggableResizable :onResize="onResizeCallback">
```
...
```html
<ReactDraggableResizable @activated="onActivated">
```
...
```html
<ReactDraggableResizable @deactivated="onDeactivated">
```
...
```html
<ReactDraggableResizable @resizing="onResizing">
```
...
```html
<ReactDraggableResizable @resizestop="onResizestop">
```
...
```html
<ReactDraggableResizable @dragging="onDragging">
```
...
```html
<ReactDraggableResizable @dragstop="onDragstop">
```
...
You can style the component using appropriate class names passed as props to the component. Moreover you can replace the default styles for the handles, provided in the source file `react-draggable-resizable.css`, but you should take care to define position and size for them. The default classes for handles are `handle` and `handle-tl`, `handle-br` and so on.
